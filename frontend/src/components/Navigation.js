    ...
    const checkAuthState = () => {
      ...
      if (localAuth) {
        try {
          ...
          console.log('🔐 Navigation: Auth data found:', authData);
        } catch (e) {
          console.error('🔐 Navigation: Error parsing auth data:', e);
        ...
        console.log('🔐 Navigation: Auth token found');
      } else {
        setIsAuthenticated(false);
        setUser(null);
        console.log('🔐 Navigation: No auth data found');
      }
    };
