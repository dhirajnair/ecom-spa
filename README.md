...
```
Frontend (React SPA) → API Gateway → AWS Cognito (Auth)
         ↓                ↓              ↓
    Lambda Function  Product Service   Cart Service
         ↓              ↓               ↓
     Static Assets   Lambda Function  Lambda Function
                          ↓               ↓
...
```
React SPA (3001) ↔ Product Service (8001) ↔ Cart Service (8002)
                            ↓                      ↓
                        DynamoDB Local (8000)
```
